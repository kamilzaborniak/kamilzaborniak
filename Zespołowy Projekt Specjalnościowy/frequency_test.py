...
# L = 2**8
def freq_test(numbers, L=2 ** 3, M=2 ** 31):
...
def ParseArguments():
    ...
    parser.add_argument('--input-dir', default="other", required=False,
                        help='input directory with .pkl files (default: %(default)s)')
    parser.add_argument('--pval-file', default="freq-rc4.csv", required=False,
